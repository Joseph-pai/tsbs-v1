...
import { Search, TrendingUp, Sparkles, Filter, Loader2, Flame, Settings, Target, BarChart3, Info, BookOpen, X, HelpCircle, AlertTriangle, History, Trash2, Calendar, FlaskConical, CheckCircle2, XCircle, LogOut, RefreshCw, Download, ChevronLeft, ChevronRight, CheckSquare, Square, Compass } from 'lucide-react';
            ...
            <div className="flex justify-end mb-4 pr-2">
              <button
                onClick={async () => {
                  ...
                  // 等待 React 完成 re-render（按鈕切換成 loading 狀態）
