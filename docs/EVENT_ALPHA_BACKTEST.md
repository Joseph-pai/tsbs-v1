...
| :--- | :---: | :---: | :---: |
| 有效樣本數 (Sample Size) | 19 | 0 | - |
| 5D +10% 命中率 | 47.37% | 0.00% | -47.37% |
| D+1 命中率 | 0.00% | 0.00% | - |
| D+2 命中率 | 15.79% | 0.00% | - |
| D+3 命中率 | 10.53% | 0.00% | - |
| D+4 命中率 | 10.53% | 0.00% | - |
| D+5 命中率 | 10.53% | 0.00% | - |
| 平均最大報酬 | 9.18% | 0.00% | -9.18% |
| 中位數最大報酬 | 8.71% | 0.00% | -8.71% |
| 平均達標天數 | 3.33 天 | 0.00 天 | -3.33 天 |
| 最大回撤 | 34.10% | 0.00% | - |
...
- Treatment 5D+10% 命中率差距 (-47.37pp) 未達顯著門檻 (+5pp)
- Treatment 組有效樣本數 (0) 不足 10 筆，證據不充分
- Treatment 平均最大報酬未超越 Control (差距 -9.18pp)
